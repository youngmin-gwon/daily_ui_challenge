...
//     var _image = img.Image.fromBytes(
//         width.toInt(), height.toInt(), backgroundBytes,
...
//     for (var y = widthR; y < yLimit; y += widthR) {
//       for (var x = 1; x < widthR - 1; x++) {
//         final tileIndex = x + y;
...
//     for (int y = widthR, yi = 1; y < yLimit; yi++, y += widthR) {
//       for (var x = 0; x < widthR - 1; x++) {
//         final tileIndex = x + y;
//         var xOffsetD = (current[tileIndex + 1] - current[tileIndex - 1]);
//         var yOffsetD =
//             (current[tileIndex + widthR] - current[tileIndex - widthR]);
